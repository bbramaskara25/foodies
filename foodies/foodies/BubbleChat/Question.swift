...
let sampleQuestions: [Question] = [
    Question(text: "Sekarang kamu ada di GOP berapa?", options: ["GOP 1", "GOP 6", "GOP 9", "Prefer not to mention"]),
    Question(text: "Berapa budget makan kamu?", options: ["<20.000", "20.000-30.000", ">30.000", "Prefer not to mention"]),
